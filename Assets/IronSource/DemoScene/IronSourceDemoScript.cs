...
public class IronSourceDemoScript : MonoBehaviour
{
    ...
    public static IronSourceDemoScript _IronSourceDemoScript;

    private void Awake()
    {
        _IronSourceDemoScript = this;
    }
...
#if UNITY_ANDROID
       // string appKey = "85460dcd";//test
        string appKey = "6e84ca45";
#elif UNITY_IPHONE
        ...
        IronSourceDemoScript._IronSourceDemoScript.logger.text += "\nunity-script: IronSource.Agent.validateIntegration";
    ...
    void BannerAdLoadedEvent()
    {
        ...
        _IronSourceDemoScript.logger.text += "\n unity-script: I got BannerAdLoadedEvent ";
    }

    void BannerAdLoadFailedEvent(IronSourceError error)
    {
        Debug.Log("unity-script: I got BannerAdLoadFailedEvent, code: " + error.getCode() + ", description : " + error.getDescription());
        _IronSourceDemoScript.logger.text += "\nunity-script: I got BannerAdLoadFailedEvent, code: " + error.getCode() +
